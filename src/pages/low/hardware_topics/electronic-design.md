...
You can find the schematic of a Luos-ready board called `L0` for a quick hardware example (available <a href="https://github.com/Luos-io/Examples/tree/master/Hardware/l0" target="_blank">on GitHub</a>).
...
## Compatible MCUs
Luos can manage any type of microcontrollers, but they first need to be added to the library manually. If your microcontroller is not supported yet, please contact us:
