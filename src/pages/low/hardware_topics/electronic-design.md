...
You can find the schematic of a Luos-ready board called `L0` <a href="https://en.wikipedia.org/wiki/Microcontroller" target="_blank">here<a> for a quick hardware example.
